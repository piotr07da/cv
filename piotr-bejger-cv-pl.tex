...
\cvSectionEntry
{
	...
	\cvSectionEntryBody{Wybrane osiągnięcia:}
	{
		\begin{itemize}
			...
			\item Stworzenie mechanizmów i narzędzi do ułatwienia zarządzania konfiguracją systemu zarówno na środowiskach developerskich jak i produkcyjnych. Dzięki temu uzyskanie sprawniejszego i mniej ryzykownego deploymentu.
		\end{itemize}
	}
}
